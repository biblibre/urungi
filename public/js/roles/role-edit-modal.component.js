(function () {
    ...
    RoleEditModalController.$inject = ['gettextCatalog', 'toastr', 'api', 'userService', '$rootScope'];

    function RoleEditModalController (gettextCatalog, toastr, api, userService, $rootScope) {
        const vm = this;
        ...
        function save () {
            ...
            return p.then(function (role) {
                ...
                toastr.error(gettextCatalog.getString('Failed to save role'));
            });
        }
