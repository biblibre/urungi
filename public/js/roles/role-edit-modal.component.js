(function () {
    ...
    RoleEditModalController.$inject = ['Noty', 'api', 'userService'];

    function RoleEditModalController (Noty, api, userService) {
        const vm = this;
        ...
        function save () {
            ...
            return p.then(function (role) {
                ...
                new Noty({ text: 'Failed to save role', type: 'error' }).show();
            });
        }
