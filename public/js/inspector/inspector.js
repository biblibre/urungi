...
angular.module('wst.inspector', [])
    ...
    .factory('css', ['$rootScope', function ($rootScope) {
         ...
         */
            compile: function () {
                var css = '';
                var obj = $.extend(true, {}, this.rules);
     ...
     */
        manager.reorderElement.prototype.insertAtIndex = function (type) {
            ...
            if (index === 0) {
                ...
                var currentIndex = contents.index(this.params.node);
    ...
    .factory('inspector', ['$rootScope', 'css', 'undoManager', function ($rootScope, css, undoManager) {
         ...
         */
            changeStyle: function (prop, attr, sides, value, append) {
                ...
                let property;
                if (!attr) {
                    property = this.styles[prop];
                } else {
                    property = this.styles[prop][attr];
                }
            ...
            applySliderValue: function (name, value, append) {
                let prop;
                if (name === 'borderWidth') {
                    prop = this.styles.border.width;
                } else if (name === 'borderRadius') {
                    prop = this.styles.border.radius;
                } else {
                    prop = this.styles[name];
                }
    ...
    .directive('blShowImgContainer', ['$timeout', function ($timeout) {
        return {
            ...
            link: function ($scope, el, attrs, controller) {
                ...
                var arrow = $('#background-arrow');
                var presets = { texture: $('#texturePresets'), gradient: $('#gradientPresets') };
