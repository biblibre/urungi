(function () {
    ...
    LayersListController.$inject = ['$scope', '$location', '$timeout', '$uibModal', 'notify', 'connection', 'api', 'gettext', 'gettextCatalog', 'userService'];

    function LayersListController ($scope, $location, $timeout, $uibModal, notify, connection, api, gettext, gettextCatalog, userService) {
        const vm = this;
