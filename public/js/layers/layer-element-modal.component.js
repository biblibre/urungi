(function () {
    ...
    angular.module('app.layers').component('appLayerElementModal', {
        templateUrl: 'partials/layers/layer-element-modal.html',
        controller: LayerElementModalController,
        controllerAs: 'vm',
        bindings: {
            resolve: '<',
            close: '&',
    ...
    LayerElementModalController.$inject = ['gettextCatalog', 'layerUtils', 'layerElementTypes', 'layerNumberDefaultAggregation', 'layerStringDefaultAggregation'];

    function LayerElementModalController (gettextCatalog, layerUtils, layerElementTypes, layerNumberDefaultAggregation, layerStringDefaultAggregation) {
