(function () {
    ...
    angular.module('app.layers').component('appLayerSqlModal', {
        templateUrl: 'partials/layers/layer-sql-modal.html',
        controller: LayerSqlModalController,
        controllerAs: 'vm',
        bindings: {
            resolve: '<',
            close: '&',
    ...
    LayerSqlModalController.$inject = ['api', 'layerService'];

    function LayerSqlModalController (api, layerService) {
        const vm = this;
            ...
            api.getSqlQueryCollection(vm.layer.datasourceID, sqlCollection).then(function (newCol) {
                ...
                for (const e1 of newCol.elements) {
                    ...
                    if (elementInCurrentCollection) {
                        ...
                        e1.elementID = layerService.newID(vm.layer);
