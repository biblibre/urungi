angular.module('app').controller('reportCtrl', function ($scope, connection, $compile, reportsService, $routeParams, $timeout, c3Charts, $uibModal,
    reportModel, widgetsCommon, $location, gettextCatalog, $q, toastr, layerService, api, $rootScope, userService) {
    ...
    */
    ...
    $scope.cleanForm = function () {
        ...
        if (!report.properties) {
            toastr.error(gettextCatalog.getString('invalid report'));
            return;
        }
    ...
    */
    ...
    $scope.changeReportType = function (newReportType) {
        ...
        default:
            toastr.error(gettextCatalog.getString('report type does not exist'));
            break;
        }
