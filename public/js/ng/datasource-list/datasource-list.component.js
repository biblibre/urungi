(function () {
    ...
    DatasourceListController.$inject = ['$timeout', '$window', 'connection', 'api', 'gettextCatalog'];

    function DatasourceListController ($timeout, $window, connection, api, gettextCatalog) {
        const vm = this;
        vm.IntroOptions = {};
