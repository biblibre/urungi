(function () {
    ...
    angular.module('app.pdf-export', ['app.core']);

    angular.module('app.pdf-export').component('appPdfExportSettingsModal', {
        templateUrl: 'partials/pdf-export/pdf-export.pdf-export-settings-modal.component.html',
