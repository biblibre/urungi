(function () {
    ...
    angular.module('app.report-edit').component('appReportColumnSettingsModal', {
        templateUrl: 'partials/report-edit/report-edit.report-column-settings-modal.component.html',
