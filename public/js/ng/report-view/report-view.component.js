...
ReportViewController.$inject = ['$scope', '$timeout', '$location', '$window', 'api', 'xlsxService', 'userService', 'reportsService', 'reportModel'];

function ReportViewController ($scope, $timeout, $location, $window, api, xlsxService, userService, reportsService, reportModel) {
    const vm = this;
