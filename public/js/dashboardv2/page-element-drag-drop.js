    ...
    return {
        ...
        link: function (scope, el, attrs, controller) {
            ...
            el.bind('blur', function (e) {
                ...
                if (scope.editMode && scope.editCommand) {
                    // var self = this;
        ...
        link: function (scope, el, attrs, controller) {
            ...
            el.bind('dragover', function (e) {
                ...
                if (y < mar.height - 10 && y > 10) {
                    ...
                    if (theNDType === 'mainContainer') { $(el).removeClass('selectedImage'); }
                }
            });
            ...
            el.bind('drop', function (e) {
                ...
                getTemplate($compile, scope, dropType, function (template) {
                    ...
                    if (mode === 'before') {
                        ...
                        const src2 = document.getElementById(data);
                        if (src2 && typeof dropType === 'undefined') {
                            $(src2).remove();
                        }
                    }
        ...
        if (destType === 'photoHeader') {
            ...
            if (destType === 'homeFull') {
                ...
                if (destType === 'image') {
                    ...
                    } else { theTemplate = $compile('<div class="container-fluid image ndContainer" x-lvl-draggable="false" x-lvl-drop-target="true" ndType="container" x-on-select="selected(selectedEl)" > <div class="embed-responsive embed-responsive-16by9 ndContainer" ndType="none" ><img  x-lvl-draggable="false" x-lvl-drop-target="true" ndType="image" x-on-select="selected(selectedEl)" src="' + dropID + '"  allowfullscreen></img></div></div>')(scope); }
                }
            }
        }
    }
