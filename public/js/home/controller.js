...
angular.module('app').controller('homeCtrl', ['$scope', '$rootScope', 'connection', 'gettextCatalog', 'usersModel', function ($scope, $rootScope, connection, gettextCatalog, usersModel) {
