...
app.controller('pagesCtrl', function ($scope, connection, $routeParams, reportModel, $compile, promptModel,queryService, dashboardModel, $filter, $rootScope) {
    ...
    $scope.newQuery = function() {
        ...
        $scope.query = {name:'Query'+$scope.queries.length +1};
    }
