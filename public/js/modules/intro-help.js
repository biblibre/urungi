        ...
        link: function (scope, el, attrs, controller) {
            ...
            scope.showHelpForElement = function (theElement) {
                ...
                if ($(theElement).offset()) {
                    ...
                    if (scope.introElements[scope.actualStep].width) { theWidth = scope.introElements[scope.actualStep].width; }
                    if (scope.introElements[scope.actualStep].height) { theHeight = scope.introElements[scope.actualStep].height; }
                    ...
                    if (scope.introElements[scope.actualStep].intro) { scope.intro = scope.introElements[scope.actualStep].intro; } else scope.intro = '';
            ...
            function checkForVisibleElements () {
                ...
                for (var i in scope.ngIntroOptions.steps) {
                    if ($(scope.ngIntroOptions.steps[i].element).offset()) { scope.introElements.push(scope.ngIntroOptions.steps[i]); }
                    if (!scope.ngIntroOptions.steps[i].element) { scope.introElements.push(scope.ngIntroOptions.steps[i]); }
                }
            }
